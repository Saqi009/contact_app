...
@section('content')
    <div class="row mb-3">
        ...
        <div class="col-6 text-end">
            <a href="{{ route('user.contacts', $contact) }}" class="btn btn-outline-primary">Back</a>
        </div>
    </div>
                    ...
                    <div class="text-center">
                        ...
                        <div class="row">
                            <div class="col-md-8 mx-auto">
                                <form action="{{ route('user.contact.picture', $contact) }}" method="POST" class="row g-3"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="mobile" name="mobile"
                                        ...
                                        value="{{ old('mobile') ?? $contact->mobile }}" placeholder="Mobile!">
                                    @error('mobile')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
